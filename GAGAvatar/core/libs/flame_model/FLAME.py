...
class FLAMEModel(nn.Module):
    ...
    # @torch.no_grad()
    def forward(self, shape_params=None, expression_params=None, pose_params=None, eye_pose_params=None, verts_scale=None):
        """
            Input:
        ...
        if verts_scale is not None:
            return vertices * verts_scale, landmark_3d * verts_scale
