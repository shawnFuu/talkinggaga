...
LMDBEngine = importlib.util.spec_from_file_location("LMDBEngine", "/home/fuxiaowen/3DGS/GAGAvatar/core/libs/GAGAvatar_track/engines/utils_lmdb.py").loader.load_module().LMDBEngine
OptimEngine = importlib.util.spec_from_file_location("OptimEngine", "/home/fuxiaowen/3DGS/GAGAvatar/core/libs/GAGAvatar_track/engines/engine_optim.py").loader.load_module().OptimEngine
VGGHeadDetector = importlib.util.spec_from_file_location("VGGHeadDetector", "/home/fuxiaowen/3DGS/GAGAvatar/core/libs/GAGAvatar_track/engines/vgghead_detector/VGGDetector.py").loader.load_module().VGGHeadDetector
FLAMEModel = importlib.util.spec_from_file_location("FLAMEModel", "/home/fuxiaowen/3DGS/GAGAvatar/core/libs/GAGAvatar_track/engines/flame_model/FLAME.py").loader.load_module().FLAMEModel
RenderMesh = importlib.util.spec_from_file_location("RenderMesh", "/home/fuxiaowen/3DGS/GAGAvatar/core/libs/GAGAvatar_track/engines/flame_model/renderer_utils.py").loader.load_module().RenderMesh
ImageEngine = importlib.util.spec_from_file_location("ImageEngine", "/home/fuxiaowen/3DGS/GAGAvatar/core/libs/GAGAvatar_track/engines/emica_encoder/utils_data.py").loader.load_module().ImageEngine
EmicaEncoder = importlib.util.spec_from_file_location("EmicaEncoder", "/home/fuxiaowen/3DGS/GAGAvatar/core/libs/GAGAvatar_track/engines/emica_encoder/EmicaEncoder.py").loader.load_module().EmicaEncoder
HumanMattingEngine = importlib.util.spec_from_file_location("HumanMattingEngine", "/home/fuxiaowen/3DGS/GAGAvatar/core/libs/GAGAvatar_track/engines/human_matting/matting_engine.py").loader.load_module().StyleMatteEngine
...
class CoreEngine:
    ...
    def track_image(self, inp_images, inp_keys, if_matting=True):
        ...
        for inp_key, inp_image in tqdm(zip(inp_keys, inp_images), total=len(inp_images), leave=False):
        ...
        for key in optim_results:
            pred_vertices, _ = flame_model( # [1, 5023, 3]
            ...
            rendered_image, alpha_image = mesh_render( # [1, 3, 512, 512]
