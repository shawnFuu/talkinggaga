...
stylematte_spec = importlib.util.spec_from_file_location("StyleMatte", "/home/fuxiaowen/3DGS/GAGAvatar/core/libs/GAGAvatar_track/engines/human_matting/stylematte.py")
stylematte = importlib.util.module_from_spec(stylematte_spec)
stylematte_spec.loader.exec_module(stylematte)
StyleMatte = stylematte.StyleMatte
