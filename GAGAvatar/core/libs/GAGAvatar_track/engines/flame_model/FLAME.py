...
spec = importlib.util.spec_from_file_location("lbs", "/home/fuxiaowen/3DGS/GAGAvatar/core/libs/GAGAvatar_track/engines/flame_model/lbs.py")
lbs_module = importlib.util.module_from_spec(spec)
spec.loader.exec_module(lbs_module)

lbs = lbs_module.lbs
batch_rodrigues = lbs_module.batch_rodrigues
vertices2landmarks = lbs_module.vertices2landmarks
